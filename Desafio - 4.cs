...
namespace Desafio__Primeiro_Projeto
{
    internal class Desafio__4
    {
        public static void Executar()
        {
            ...
            /* 2. Criar um programa que gerencie o estoque de uma loja. Utilize um dicionário para armazenar produtos e suas quantidades em estoque e mostre, 
            ...
            /* 3. Crie um programa que implemente um quiz simples de perguntas e respostas. Utilize um dicionário para armazenar as perguntas 
            ...
            if (usuario.ContainsKey(nomeUsuario) && usuario[nomeUsuario] == senhaUsuario)
            {
